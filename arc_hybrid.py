...
class ArcHybridLSTM:
    ...
    def Init(self):
        ...
        paddingVec = tanh(self.word2lstm.expr() * concatenate([_f for _f in [paddingWordVec, paddingPosVec, evec] if _f]) + self.word2lstmbias.expr() )
    ...
    def getWordEmbeddings(self, sentence, train):
        for root in sentence:
            ...
            if self.external_embedding is not None:
                ...
                root.evec = None
            root.ivec = concatenate([_f for _f in [root.wordvec, root.posvec, root.evec] if _f])
    ...
    def Train(self, conll_path):
        ...
        #self.trainer.update_epoch() #original!
        self.trainer.update()
